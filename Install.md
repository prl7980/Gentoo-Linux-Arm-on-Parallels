...
check the results, should be 17 

grep -E "CONFIG_DRM=|CONFIG_DRM_KMS_HELPER=|CONFIG_DRM_SIMPLEDRM=|CONFIG_DRM_VIRTIO_GPU=|CONFIG_FRAMEBUFFER_CONSOLE=|CONFIG_INPUT_EVDEV=|CONFIG_DEVTMPFS=|CONFIG_DEVTMPFS_MOUNT=|CONFIG_SOUND=|CONFIG_SND=|CONFIG_SND_PCM=|CONFIG_SND_TIMER=|CONFIG_SND_HDA=|CONFIG_SND_HDA_CORE=|CONFIG_SND_HDA_INTEL=|CONFIG_SND_HDA_GENERIC=|CONFIG_SND_HDA_CODEC_ANALOG=" .config
